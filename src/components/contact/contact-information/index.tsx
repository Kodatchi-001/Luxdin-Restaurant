export default function Contact_Information() {
    return <>
        <section className="w-full h-full flex justify-center mt-2 lg:mt-10">
            <div className="w-full 2xl:max-w-[1600px] h-full flex justify-between flex-wrap gap-10 lg:gap-0 px-5 lg:px-20 py-20">
                <div className="w-full lg:w-[52%] h-[30vh] lg:h-[70vh] 2xl:max-h-[600px] background-image-size" style={{ backgroundImage: `url(https://framerusercontent.com/images/GDhlzXKekfUMVfrV89UZoG7EFA.png)` }}>
                </div>
