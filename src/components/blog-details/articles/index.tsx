...
export default function Articles({ Props }: PropsBlogdetailsType) {
    ...
    return <>
        <section className="w-full flex justify-between flex-wrap gap-14 lg:gap-0 px-5 xl:px-28 mt-10 lg:mt-20 mb-14 lg:mb-32">
                ...
                BlogDetails
                    ...
                    .map((item: BlogDetailsTypes) => (
                        <div key={item.id} className="w-full lg:w-[62%] h-full flex flex-col gap-8">
                            ...
                            <div
                                className="w-full h-[40vh] lg:h-[70vh] 2xl:h-[50vh] mt-8 background-image-size"
