    ...
    return <>
        ...
        <section className="w-full h-auto flex flex-wrap gap-14">
            <div className="w-full lg:h-[45vh] flex flex-col justify-center lg:pt-14 gap-20 items-center text-4xl lg:text-7xl">
                ...
                <ul className="w-full lg:w-[60%] h-1/5 flex justify-center lg:justify-between items-center font-semibold text-[17px] flex-wrap gap-3 lg:gap-0">
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "All" && ShareCategories === '' ? 'text-[#d1a374]' : ''} `}
                        onClick={() => FilterCards('All')}>
                        ALL CATEGORY
                    </li>
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "Main Dishes" || ShareCategories === "Main Dishes" ? 'text-[#d1a374]' : ''} `}
                        onClick={() => FilterCards('Main Dishes')}>
                        MAIN DISHES
                    </li>
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "Disserts" || ShareCategories === "Disserts" ? 'text-[#d1a374]' : ''} `}
                        onClick={() => FilterCards('Disserts')}>
                        DISSERTS
                    </li>
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "Appetizers" || ShareCategories === "Appetizers" ? 'text-[#d1a374]' : ''} `}
                        onClick={() => FilterCards('Appetizers')}>
                        APPETIZERS
                    </li>
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "Soup" || ShareCategories === "Soup" ? 'text-[#d1a374]' : ''} `}
                        onClick={() => FilterCards('Soup')}>
                        SOUP
                    </li>
                    <li className={`w-[30%] lg:w-auto text-center cursor-pointer duration-200 ${Filter === "Salad" || ShareCategories === "Salad" ? 'text-[#d1a374]' : ''} `}
