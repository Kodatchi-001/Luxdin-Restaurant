export default function Specialty() {
    return <>
        <section className="w-full mt-20 px-3 lg:px-5 xl:px-20 flex flex-col gap-8 lg:gap-5">
            <div className="w-full lg:h-[20vh] flex flex-col items-center gap-3 lg:gap-5">
                <h2 className="text-xl text-[#d1a374]">OUR SPECIALTY</h2>
                <h1 className="text-3xl lg:text-6xl">Fine Dining Experience</h1>
            </div>
            <div className="w-full lg:h-[90vh] py-3 flex flex-wrap gap-8 lg:gap-0">
