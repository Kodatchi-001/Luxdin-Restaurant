...
export default function Blogs() {
    ...
    return <>
        <section className="w-full h-full flex justify-center mt-5 lg:mt-20">
            <div className="w-full 2xl:max-w-[1600px] h-full lg:h-auto px-4 lg:px-5 xl:px-20 lg:py-10 flex flex-wrap lg:flex-nowrap gap-6 ">
