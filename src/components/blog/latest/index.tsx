...
export default function Latest() {
    ...
    return <>
        <section className="w-full flex flex-wrap gap-10 lg:gap-14 mt-10 lg:mt-24 px-4 lg:px-5 xl:px-20">
                    ...
                    BlogCards
                        ...
                        .map((item: BlogCardsTypes) => (
                            <div key={item.id} className="w-full sm:w-[48%] lg:w-[48.5%] h-full flex flex-wrap lg:gap-8">
                                <div className="w-full h-[45vh] lg:h-[65vh] flex justify-end relative Blog-Card-1 background-image-size" style={{ backgroundImage: `url(${item.Picture})` }}>
