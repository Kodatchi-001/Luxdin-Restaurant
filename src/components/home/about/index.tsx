export default function AboutHome() {
    return <>
        <section className="w-full flex justify-center mt-5 lg:mt-24 lg:mb-24 lg:px-6 xl:px-20">
            <div className="w-full 2xl:max-w-[1600px] h-full gap-8 sm:gap-10 lg:gap-3 flex flex-wrap-reverse lg:flex-nowrap">
                <div className="w-full lg:w-[35%] h-full flex justify-center items-center lg:px-8 xl:px-14 2xl:px-16 lg:py-4">
