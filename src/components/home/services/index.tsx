...
export default function ServicesHome() {
    return <>
        <section className="w-full flex justify-center mt-14 px-2 lg:px-5 xl:px-20 py-6">
            <div className="w-full 2xl:max-w-[1600px] h-full flex flex-col justify-between gap-5 sm:gap-8 lg:gap-10">
