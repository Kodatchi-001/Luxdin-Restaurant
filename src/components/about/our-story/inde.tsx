export default function OurStory() {
    return <>
        <section className="w-full lg:h-screen mt-10 lg:mt-16 flex justify-between flex-wrap gap-5 lg:gap-0 lg:pl-5 xl:pl-16 lg:pr-14 xl:pr-20">
            <div className="w-full lg:w-[65%] h-full flex flex-wrap py-4 gap-10 lg:gap-0 px-1 lg:px-0">
                <div className="w-full h-5/6 pl-2 lg:px-10 xl:px-16 lg:pt-20 lg:pb-14 flex flex-col justify-between gap-7 lg:gap-3 xl:gap-0">
            ...
            <div className="w-full lg:w-[30%] h-[50vh] lg:h-full lg:px-3 xl:px-8 2xl:px-10 lg:py-14">
